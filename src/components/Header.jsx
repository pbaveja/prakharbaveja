...
import avatarImage from '@/images/avatarPrakharSmall.jpeg'
import avatarImageBlack from '@/images/avatarPrakharSmallBlack.jpeg'
...
function MobileNavigation(props) {
  return (
    <Popover {...props}>
      ...
      <PopoverBackdrop
        transition
        className="fixed inset-0 z-50 bg-zinc-900/40 duration-150 data-[closed]:opacity-0 data-[enter]:ease-out data-[leave]:ease-in dark:bg-black/80"
      />
      <PopoverPanel
        focus
        transition
      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y-2 divide-black border-2 border-black text-base text-black dark:divide-white dark:border-white dark:text-white">
            ...
            <MobileNavItem href="/spotify">Spotify&nbsp;x&nbsp;Me</MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex divide-x-2 divide-black rounded-none border-2 border-black bg-white text-sm shadow-brutal-sm dark:divide-white dark:border-white dark:bg-ink">
        ...
        <NavItem href="/spotify">Spotify&nbsp;x&nbsp;Me</NavItem>
...
function Avatar({ large = false, className, ...props }) {
  ...
  return (
    ...
    >
      <Image
        src={resolvedTheme === 'light' ? avatarImage : avatarImageBlack}
        alt=""
