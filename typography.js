  ...
  return {
    ...
    DEFAULT: {
      css: {
        ...
        '--tw-prose-underline': theme('colors.blue.600 / 0.3'),
        ...
        '--tw-prose-pre-border': theme('colors.black'),
        ...
        '--tw-prose-invert-pre-border': theme('colors.white'),
        ...
        a: {
          ...
          transitionProperty: 'background-color, color, text-decoration-color',
